...
(function (U, V) {
    ...
    G = function (a) {
        var b, c, d, e, g, h = arguments[0] || {}, f = 1,
            j = arguments.length,
            a = !1;
    ...
    K = function (a, b, c) {
        ...
        for (!T && f && (l = f.fromGregorian(a));;) {
            ...
            case "t":
            case "tt":
                k = a.getHours() < 12 ? h.AM ? h.AM[0] : " " : h.PM ? h.PM[0] : " ";
    ...
    (function () {
        ...
        a = function (a, c, d) {
            ...
            d = d[","];
            for (j = ""; c >= 0;) {
                if (g === 0 || g > c) return a.slice(0, c + 1) + (j.length ? d + j + f : f);
    ...
    (function () {
        ...
        M = function (f, h, g) {
            ...
            h === null ? h = s : g.eras && (h += g.eras[f || 0].offset);
            q === null && (q = 0);
            r === null && (r = 1);
            if (y) {
    ...
    i.prototype.parseInt = function (a, b, c) {
    ...
    i.parseDate = function (a, b, c) {
        var c = this.findClosestCulture(c),
            d, e;
        if (b) {
            ...
            for (e in b = c.calendar.patterns, b)
                if (d = M(a, b[e], c)) break; return d || null
    };
    ...
    i.parseFloat = function (a, b, c) {
        ...
        var d = this.findClosestCulture(c),
            c = NaN,
            e = d.numberFormat;
        a.indexOf(d.numberFormat.currency.symbol) > -1 && (a = a.replace(d.numberFormat.currency.symbol, ""), a = a.replace(d.numberFormat.currency["."], d.numberFormat["."]));
        a = u(a);
...
(function () {
    ...
    var A, C = document,
        ...
        Sb = cb && parseInt(na.split("Firefox/index.html")[1], 10) < 4,
                ...
                for (c in a)
                    if (j = !1, d = a[c], e = k[c] && k[c].call(this, d, c), e !== !1) {
                        ...
                        if (l && /^(width|height|visibility|x|y|d|transform)$/.test(c))
                            for (e = l.length; e--;) w(l[e], c, c === "height" ? s(d - (l[e].cutHeight || 0), 0) : d);
        ...
        add: function (a) {
            ...
            if (c.handleZ)
                for (c = 0; c < e.length; c++)
                    if (a = e[c], b = w(a, "zIndex"), a !== f && (z(b) > g || !r(g) && r(b))) {
                        d.insertBefore(f, a);
                        h = !0;
                        break
                    }
            ...
            o(c, function (c, d) {
                ...
                o(h, function (c) {
                    if (c !== "" || h.length === 1) {
                        ...
                        if (!y) {
                            if (d) {
                                ...
                                if (!t || isNaN(t)) {
                                    var r;
                                    if (!(r = j))
                                        if (!(r = k.offsetHeight)) l[d] = b.getBBox ? b.getBBox().height : a.renderer.fontMetrics(b.style.fontSize).h, r = u(l[d] - (l[d - 1] || 0)) || 18;
                                    t = r
                                }
                                w(n, "dy", t)
                            }
                        ...
                        y++;
                        if (i)
                            for (var c = c.replace(/([^\^])-/g, "$1- ").split(" "), E = []; c.length || E.length;) delete a.bBox, r = a.getBBox().width, m = r > i, !m || c.length === 1 ? (c = E, E = [], c.length && (n = C.createElementNS(oa, "tspan"), w(n, {
                                dy: j || 16,
                                x: g
        ...
        var fa = {
            ...
            color: function (a, b, c, d) {
                ...
                if (i) {
                    ...
                    if (c === "fill")
                        if (i === "gradient") c = m.x1 || m[0] || 0, a = m.y1 || m[1] || 0, q = m.x2 || m[2] || 0, m = m.y2 || m[3] || 0, r = 'angle="' + (90 - K.atan((m - a) / (q - c)) * 180 / Aa) + '"', u();
                        else {
                            var j = m.r,
                                E = j * 2,
                                S = j * 2,
    ...
    nb.prototype = {
        render: function () {
            ...
            } else return; if (r(o)) d.zIndex = o;
            if (q) p ? q.animate({
                d: p
            }, null, q.onGetPath) : (q.hide(), q.onGetPath = function () {
                q.show()
            });
            else if (p && p.length && (a.svgElem = q = v.path(p).attr(d).add(), u))
                for (y in e = function (b) {
                    q.on(b, function (c) {
                        u[b].apply(a, [c])
                    })
                }, u) e(y);
    ...
    ob.prototype = {
        ...
        defaultLabelFormatter: function () {
            ...
            if (a.categories) f = b;
                ...
                for (; e-- && f === A;) a = Math.pow(1E3, e + 1), g >= a && d[e] !== null && (f = Ja(b / a, -1) + d[e]);
            ...
            o(a.series, function (g) {
                if (g.visible || !b.options.chart.ignoreHiddenSeries) {
                    ...
                    if (a.isXAxis) {
                        ...
                        u = p.length;
                        for (f = 0; f < u; f++)
                            if (y = h[f], t = p[f], i && (E = (z = t < o) ? k : j, S = z ? q : l, r(E[y]) ? (E[y] = da(E[y] + t), t = [t, E[y]]) : E[y] = t, c[S] || (c[S] = {}), c[S][y] || (c[S][y] = new Kb(a, a.options.stackLabels, z, y, m, i)), c[S][y].setTotal(E[y])), t !== null && t !== A && (C && (t = g.modifyValue(t)), w || (h[f + 1] || y) >= B.min && (h[f - 1] || y) <= B.max))
                                if (y = t.length)
                                    for (; y--;) t[y] !== null && (v[x++] = t[y]);
                                else v[x++] = t;
                        if (!a.usePercentage && v.length) a.dataMin = O(n(a.dataMin, v[0]), Fa(v)), a.dataMax = s(n(a.dataMax, v[0]), wa(v));
                        if (r(o))
                            if (a.dataMin >= o) a.dataMin = o, a.ignoreMinPadding = !0;
        ...
        getOffset: function () {
            ...
            if (b || a.isLinked) o(e, function (b) {
                ...
                for (H in f) f[H].destroy(), delete f[H]; if (m && m.text) {
    ...
    pb.prototype = {
        ...
        refresh: function (a, b) {
            ...
            if (q) {
                q = la(q);
                for (e = q.length; e--;)
                    if (i = a.series[e ? "yAxis" : "xAxis"], q[e] && i)
    ...
    qb.prototype = {
        ...
        onmousemove: function (a) {
            ...
            if (d && this.options.tooltip.shared && (!g || !g.noSharedTooltip)) {
                ...
                h = c.length;
                for (i = 0; i < h; i++)
                    if (c[i].visible && c[i].options.enableMouseTracking !== !1 && !c[i].noSharedTooltip && c[i].tooltipPoints && c[i].tooltipPoints.length) b = c[i].tooltipPoints[k], b._dist = M(k - b[c[i].xAxis.tooltipPosName || "plotX"]), j = O(j, b._dist), e.push(b);
    ...
    rb.prototype = {
        ...
        colorizeItem: function (a, b) {
            ...
            if (f) {
                if (g)
                    for (j in g = a.convertAttribs(g), g) d = g[j], d !== A && (i[j] = d);
                f.attr(i)
            }
        },
    ...
    sb.prototype = {
        ...
        getMargins: function () {
            ...
            if ((this.title || this.subtitle) && !r(this.optionsMarginTop))
                if (l = s(this.title && !k.floating && !k.verticalAlign && k.y || 0, this.subtitle && !l.floating && !l.verticalAlign && l.y || 0)) this.plotTop = s(this.plotTop, l + n(k.margin, 15) + b);
        ...
        drawChartBox: function () {
            ...
            n = i + (a.shadow ? 8 : 0);
            if (i || j)
                if (e) e.animate(e.crisp(null, null, null, c - n, d - n));
                else {
                    e = {
                        fill: j || Q
                    };
    ...
    P.prototype = {
        ...
        drawPoints: function () {
            ...
            if (l.enabled || this._hasPointMarkers)
                for (f = b.length; f--;)
                    if (g = b[f], d = g.plotX, e = g.plotY, k = g.graphic, i = g.marker || {}, a = l.enabled && i.enabled === A || i.enabled, m = c.isInsidePlot(d, e, c.inverted), a && e !== A && !isNaN(e))
    ...
    fa = ba(P, {
        ...
        drawTracker: function () {
            for (var a = this, b = a.chart, c = b.renderer, d, e, f = +new Date, g = a.options, h = (d = g.cursor) && {
                ...
                if (m = l[n], e = m.tracker, d = m.trackerArgs || m.shapeArgs, k = m.plotY, k = !a.isCartesian || k !== A && !isNaN(k), delete d.strokeWidth, m.y !== null && k) {
                    if (e) e.attr(d);
                    ...
                    if (j > 0) {
                        ...
                        for (v = 0; v < C; v++) {
                            ...
                            if (D < v && w[v] !== null) D = v;
                                ...
                                for (s < C - v + D && w[v] !== null && (D = s - C + v); w[D] === null;) D++;
                            A.push({
                                i: D,
                                y: w[D]
                            });
...
Highcharts.c = {
    colors: "#a6d045 #f48634 #ED561B #DDDF00 #24CBE5 #64E572 #FF9655 #FFF263 #6AF9C4".split(" "),
    chart: {
...
jQuery(document).ready(function () {
    ...
    jQuery("ul.loanproduct-nav li").click(function () {
        "active" != jQuery(this).attr("class") && (jQuery(this).addClass("active").siblings().removeClass("active"), n = jQuery(this).attr("id"), "home-loan" == n ? G("Home Loan Amount", 1E7, 5E4, 25E5, 20, 10.5, 30, 0.5, 240) : "personal-loan" == n ? G("Personal Loan Amount", 15E5, 1E4, 35E4, 25, 17.5, 5, 0.25, 36) : "car-loan" == n && G("Car Loan Amount", 2E6, 1E4, 4E5, 20, 12.5, 7, 0.25, 60), H());
        return e
    });
    jQuery("#startmonthyear").attr("readonly", c);
    jQuery("#startmonthyear").datepicker({
        ...
        onClose: function () {
            jQuery(this).datepicker("getDate").toDateString() != k.toDateString() && H()
        },
        beforeShow: function () {
            if (0 < (selDate = jQuery(this).val()).length) t = selDate.substring(selDate.length - 4, selDate.length), s = jQuery.inArray(selDate.substring(0, selDate.length - 5), jQuery(this).datepicker("option", "monthNames")), jQuery(this).datepicker("option", "defaultDate", new Date(t, s, 1)), jQuery(this).datepicker("setDate", new Date(t, s, 1))
        }
    });
    ...
    G("Home Loan Amount", 1E7, 5E4, 25E5, 20, 10.5, 30, 0.5, 240);
    H()
});

function G(a, d, x, b, z, A, K, L, I) {
    ...
    jQuery("#loaninterest").val(1E3 * A / 1E3);
    "loanyears" == jQuery("#emicalcalulatorform input[name='loantenure']:checked").val() ? jQuery("#loanterm").val(I / 12) : jQuery("#loanterm").val(I);
...
function M() {
    f = Math.abs(jQuery("#loanamount").val().replace(/[^\d\.]/g, ""));
    g = Math.abs(jQuery("#loaninterest").val() / 12 / 100);
    h = "loanyears" == jQuery("#emicalcalulatorform input[name='loantenure']:checked").val() ? Math.abs(Math.round(12 * jQuery("#loanterm").val())) : Math.abs(jQuery("#loanterm").val());
    0 == g && (jQuery("#loaninterest").val(5), g = 0.004166666666666667, q.slider("value", 5));
    0 == h && ("loanyears" == jQuery("#emicalcalulatorform input[name='loantenure']:checked").val() ? jQuery("#loanterm").val(1) : jQuery("#loanterm").val(12), r.slider("value", 1), h = 12);
    l = 0;
    "emiadvance" == jQuery("#emicalcalulatorform input[name='emischeme']:checked").val() && (l = 1);
    j = "car-loan" == n && 1 == l ? f * g * (Math.pow(1 + g, h - 1) / (Math.pow(1 + g, h) - 1)) : f * g * (Math.pow(1 + g, h) / (Math.pow(1 + g, h) - 1));
    jQuery("#emiamount span").text(Globalize.format(Math.round(j), "n", "en-IN"));
    jQuery("#emitotalinterest span").text(Globalize.format(Math.round(j * h - f), "n", "en-IN"));
    jQuery("#emitotalamount span").text(Globalize.format(Math.round(j * h), "n", "en-IN"));
    u = [];
    v = [];
    w = [];
    y = [];
    ...
    D = [];
    E = [];
    B[0] = new Date(k.getTime());
    "car-loan" == n && 1 == l ? (D[0] = 0, C[0] = j) : (D[0] = f * g, C[0] = j - D[0]);
    E[0] = f - C[0];
    ...
    w[a] = D[0];
    y[a] = E[0];
    for (i = 1; i < h; i++) B[i] = new Date(B[i - 1].getTime()), B[i].setMonth(B[i].getMonth() + 1), D[i] = E[i - 1] * g, C[i] = j - D[i], E[i] = E[i - 1] - C[i], B[i].getFullYear() != a && (a = B[i].getFullYear(), u[d++] = a, v[a] = 0, w[a] = 0, y[a] = 0), v[a] += C[i], w[a] += D[i], y[a] = E[i];
    E[h - 1] = 0;
    y[a] = 0;
    new Highcharts.Chart({
        ...
        series: [{
            ...
            data: [
                ["Principal Loan Amount", Math.round(100 * f / (j * h))], {
                    name: "Total Interest",
                    y: Math.round(100 - 100 * f / (j * h)),
                    sliced: c,
                    selected: c
                }
            ]
    ...
    for (var a = [], d = [], x = [], b = 0, b = 0, z = u.length; b < z; b++) {
        var A = u[b];
        a[b] = A;
        d[b] = v[A];
        x[b] = w[A]
    ...
    new Highcharts.Chart({
        ...
        yAxis: {
            ...
            labels: {
                formatter: function () {
                    return "\u20b9 " +
                        Globalize.format(this.value, "n", "en-IN")
                }
            }
        },
        legend: {
        ...
        tooltip: {
            formatter: function () {
                return "<b>Year : " + this.x + "</b><br/>" + this.series.name + " : \u20b9 " + Globalize.format(this.y, "n", "en-IN") + "<br/>Total : \u20b9 " + Globalize.format(this.point.stackTotal, "n", "en-IN")
            }
        },
        plotOptions: {
            column: {
    ...
    m = '<table><tr><th id="yearheader">Year</th><th id="principalheader">Principal</th><th id="interestheader">Interest</th><th id="totalheader">Principal + Interest</th><th id="balanceheader">Balance</th></tr>';
    d = a = 0;
    for (x = u.length; d < x; d++) {
        b = u[d];
        m += '<tr class="yearlypaymentdetails"><td id="year' + b + '" class="paymentyear toggle">' + b + '</td><td class="currency"><img src="emi/images/7px-Indian_Rupee_symbol.svg_.png"> ' + Globalize.format(v[b], "n", "en-IN") + '</td><td class="currency"><img src="emi/images/7px-Indian_Rupee_symbol.svg_.png">' + Globalize.format(w[b], "n", "en-IN") + '</td><td class="currency"><img src="emi/images/7px-Indian_Rupee_symbol.svg_.png">' + Globalize.format(v[b] + w[b], "n", "en-IN") + '</td><td class="currency"><img src="emi/images/7px-Indian_Rupee_symbol.svg_.png"> ' + Globalize.format(y[b], "n", "en-IN") + "</td></tr>";
        m += '<tr id="monthyear' + b + '" class="monthlypaymentdetails"><td class="monthyearwrapper" colspan="5"><div id="monthlypaymentcontainer"><table>';
        for (z = B.length; a < z && B[a].getFullYear() == b;) m += '<tr><td class="paymentmonthyear">' + F[B[a].getMonth()] + '</td><td class="currency"><img src="emi/images/7px-Indian_Rupee_symbol.svg_.png"> ' + Globalize.format(C[a], "n", "en-IN") + '</td><td class="currency"> <img src="emi/images/7px-Indian_Rupee_symbol.svg_.png">' +
            Globalize.format(D[a], "n", "en-IN") + '</td><td class="currency"><img src="emi/images/7px-Indian_Rupee_symbol.svg_.png">' + Globalize.format(C[a] + D[a], "n", "en-IN") + '</td><td class="currency"><img src="emi/images/7px-Indian_Rupee_symbol.svg_.png">' + Globalize.format(E[a++], "n", "en-IN") + "</td></tr>";
        m += "</table></div></td></tr>"
    }
    m += "</table>";
